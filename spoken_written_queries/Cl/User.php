...
class Cl_User
{
    ...
    public function spoken_queries( array $data )
    {
        if( !empty( $data ) ){
            ...
            $scontent = mysqli_real_escape_string( $this->_con, $trimmed_data['scontent'] );
            ...
            $query = "INSERT INTO spoken_queries (id, scontent) VALUES (NULL, '$scontent')";
    ...
    /**
     *  it is for collecting the video_recommendation
     */
    ...
    public function written_queries( array $data )
    {
        if( !empty( $data ) ){
            ...
            $query = "INSERT INTO written_queries (id,username,age,gender,wcontent) VALUES (NULL,'$username','$age','$gender','$wcontent')";
            if(mysqli_query($this->_con, $query)){
                mysqli_close($this->_con);
                return true;
            };
